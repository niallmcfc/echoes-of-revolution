...
country = {
	...
	BASE_COUNTRY_TAX_EFFICIENCY = 0.50, -- Basic efficiency for taxes without 'crats and tech
	BASE_COUNTRY_ADMIN_EFFICIENCY = 0.2,
	GOLD_TO_CASH_RATE = 0.1, -- Amount of money generated per gold unit
	...
	CAMPAIGN_EVENT_BASE_TIME = 28, -- once every 4 weeks.
	...
	AI_SUPPORT_REFORM = 0.02, -- At least this many % needs to support a reform for the AI to take it
	BASE_MONTHLY_DIPLOPOINTS = 0.3, -- Base value gain for diplomatic actions each month
	DIPLOMAT_TRAVEL_TIME = 14,
	PROVINCE_OVERSEAS_PENALTY = 0.3, -- Each province req. this many goods flagged as overseas penalty 
	NONCORE_TAX_PENALTY = 0.0, -- -5% for each non-core in state
	BASE_TARIFF_EFFICIENCY = 0.25, -- baseline tariff efficiency
	COLONY_FORMED_PRESTIGE = 1, -- prestige from founding a colony.
	CREATED_CB_VALID_TIME = 24,  -- how many months 
	LOYALTY_BOOST_ON_PARTY_WIN = 0.05,
	MOVEMENT_RADICALISM_BASE = 10,
	...
	MIN_DELAY_BETWEEN_REFORMS = 2, -- months
	ECONOMIC_REFORM_UH_FACTOR = -0.2,
	MILITARY_REFORM_UH_FACTOR = -0.2,
	WRONG_REFORM_RADICAL_IMPACT = 50,
	TECH_YEAR_SPAN = 101,
	...
	NAVAL_BASE_SUPPLY_SCORE_BASE = 3, -- base value that is powered by level of naval base. Determines the naval supplying capabilities.
	NAVAL_BASE_SUPPLY_SCORE_EMPTY = 3, -- min value for coastal provinces with no naval base.
	...
	COLONIZATION_PROTECTORATE_PROVINCE_MAINTAINANCE = 1,
...
economy = {
	...
	MIN_NUM_FACTORIES_PER_STATE_BEFORE_DELETING_LASSIEZ_FAIRE = 4, -- Min number of factories per state before starting to delete under Laissez Faire
	...
	TRADE_CAP_LOW_LIMIT_CONSTRUCTIONS = 0.95, 		-- the lowest % the slider can go for constructions
...
military = {
	...
	SOLDIER_TO_POP_DAMAGE = 0.3,
	LAND_SPEED_MODIFIER = 1,
	NAVAL_SPEED_MODIFIER = 2,
	EXP_GAIN_DIV = 0.05,
	LEADER_RECRUIT_COST = 40,
	SUPPLY_RANGE = 50,
	POP_MIN_SIZE_FOR_REGIMENT_PROTECTORATE_MULTIPLIER = 2,
	POP_MIN_SIZE_FOR_REGIMENT_COLONY_MULTIPLIER = 2,
	POP_MIN_SIZE_FOR_REGIMENT_NONCORE_MULTIPLIER = 2, -- VALUE * POP_MIN_SIZE_FOR_REGIMENT is min for noncores
	GAS_ATTACK_MODIFIER = 2,
	COMBATLOSS_WAR_EXHAUSTION = 10, -- base war exhaustion in combat
	LEADER_MAX_RANDOM_PRESTIGE = 0.15, -- max percent of prestige, when randomizing stats for leaders.
	LEADER_AGE_DEATH_FACTOR = 20, -- higher value means leaders live longer
	...
	LEADER_PRESTIGE_LAND_GAIN = 1, -- extra speed gain on prestige for land combat
	LEADER_PRESTIGE_NAVAL_GAIN = 1, -- extra speed gain on prestige for naval combat
...
diplomacy = {
	...
	WAR_PRESTIGE_COST_BASE = 10,
	WAR_PRESTIGE_COST_HIGH_PRESTIGE = 1,
	WAR_PRESTIGE_COST_NEG_PRESTIGE = 1,
	WAR_PRESTIGE_COST_TRUCE = 100,
	WAR_PRESTIGE_COST_HONOR_ALLIANCE = -10,
	WAR_PRESTIGE_COST_HONOR_GUARNATEE = -5,
	WAR_PRESTIGE_COST_UNCIVILIZED = -5,
	WAR_PRESTIGE_COST_CORE = -5,	
	...
	TENSION_DECAY = -0.1,
	TENSION_FROM_CB = 0.05,
	TENSION_FROM_MOVEMENT = 0.01, -- tension per 1000 in nationalist movement
	TENSION_FROM_MOVEMENT_MAX = 1.0, -- max total value no matter the size of the movement
	AT_WAR_TENSION_DECAY = -0.16, -- for each potentially interested GP at war (value is if all possible GPs are at war) 
	TENSION_ON_CB_DISCOVERED = 20,
	TENSION_ON_REVOLT = 50,
	TENSION_WHILE_CRISIS = -0.15,
	...
	CRISIS_DID_NOT_TAKE_SIDE_PRESTIGE_FACTOR_BASE = -0.05,
	...
	CRISIS_WINNER_RELATIONS_IMPACT = 50, -- negative for losers and backers with unfulfilled goals
...
pops = {
	...
	CON_LUXURY_GOODS = 0,
	CON_POOR_CLERGY = -3,
	CON_MIDRICH_CLERGY = -3,
	CON_REFORM_IMPACT = -25,
...
ai =
{
	...
	ADMINISTRATOR_WEIGHT = 4.5, -- ai weight for new bureaucrat
	...
	PEACE_WAR_EXHAUSTION_FACTOR = 0.25, -- AI willingness to peace based on war exhaustion
